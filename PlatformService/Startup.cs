    ...
    services.AddScoped<IPlatformRepo, PlatformRepo>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                // Not used in this overall application but included as this would be used to serve up a contact for other consumers outside of this microservice context
